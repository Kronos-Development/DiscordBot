    ...
    run: async (bot, message, args) => {
        ...
        if (config.Logs.Punishments.Enabled == true) {
            logs.send(Embed({
                ...
                fields: [
                    { name: lang.ModerationModule.Commands.Removewarn.Embeds.Log.Fields[0], value: `${user} (${user.id})`},
                    { name: lang.ModerationModule.Commands.Removewarn.Embeds.Log.Fields[1], value: '<@' + message.author.id + '>'},
                    { name: lang.ModerationModule.Commands.Removewarn.Embeds.Log.Fields[2], value: reason},
                    { name: lang.ModerationModule.Commands.Removewarn.Embeds.Log.Fields[3], value: warningID}
                ],
