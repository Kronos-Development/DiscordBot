...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        let infoRole = message.mentions.roles.first() || message.guild.roles.cache.find(r => r.name == args.join(" "));
        let members = "";
        let i = 0;
        ...
        message.channel.send(Embed({
            ...
            fields: [
                ...
                { name: lang.Other.OtherCommands.Roleinfo.Fields[1], value: infoRole.position, inline: true },
                { name: lang.Other.OtherCommands.Roleinfo.Fields[2], value: infoRole.permissions.bitfield, inline: true },
                { name: '\u200B', value: '\u200B', inline: true },
            ...
            footer: { text: lang.Other.OtherCommands.Roleinfo.Footer.replace(/{id}/g, infoRole.id), icon: bot.user.displayAvatarURL({ dynamic: true }) }
        }));
    },
