            ...
            case 'invalidargs':
                return {
                    embed: {
                        ...
                        description: format(lang.EmbedPresets.InvalidArgs.Description.replace(/{usage}/g, Config.Bot_Prefix + embedOptions.usage), 2048),
                        timestamp: new Date()
                    }
                }
            case 'error':
                ...
                if (embedOptions.description && embedOptions.usage) return {
                    embed: {
                        color: Error_Color,
                        title: embedOptions.description,
                        description: format(lang.EmbedPresets.Error.Descriptions[1].replace(/{usage}/g, Config.Bot_Prefix + embedOptions.usage), 2048)
                    }
                }
                return {
                    embed: {
